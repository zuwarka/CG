...
void Figure::draw_figure(float x0, float y0, float x1, float y1, float x2, float y2, float x3, float y3, int flag, int flag2 )//1 цвет, 0 тень; flag 2 - 0 ребра отличны от тени
{
...
void Figure::draw()// рисуем  параллелипипед
{
	...
	if (mull_equ_and_observer[0] >= 0)
	{
			...
			{
				draw_figure(L[0][0], L[0][1], L[1][0], L[1][1], L[2][0], L[2][1], L[3][0], L[3][1], 1, 0);//0-1-2-3
			}
			else//В тени
			{
				draw_figure(L[0][0], L[0][1], L[1][0], L[1][1], L[2][0], L[2][1], L[3][0], L[3][1], 0, 1);//0-1-2-3
			}
	}
	...
	if (mull_equ_and_observer[1] >= 0)
	{
			...
			{
				draw_figure(L[4][0], L[4][1], L[5][0], L[5][1], L[6][0], L[6][1], L[7][0], L[7][1], 1, 0);//4-5-6-7
			}
			else
			{
				draw_figure(L[4][0], L[4][1], L[5][0], L[5][1], L[6][0], L[6][1], L[7][0], L[7][1], 0, 1);//4-5-6-7
			}
	}
	...
	if (mull_equ_and_observer[2] >= 0)
	{
			...
			{
				draw_figure(L[0][0], L[0][1], L[1][0], L[1][1], L[5][0], L[5][1], L[4][0], L[4][1], 1, 0);//0-1-5-4
			}
			else
			{
				draw_figure(L[0][0], L[0][1], L[1][0], L[1][1], L[5][0], L[5][1], L[4][0], L[4][1], 0, 1);//0-1-5-4
			}
	}
	...
	if (mull_equ_and_observer[3] >= 0)
	{
			...
			{
				draw_figure(L[5][0], L[5][1], L[1][0], L[1][1], L[2][0], L[2][1], L[6][0], L[6][1], 1, 0);
			}
			else
			{
				draw_figure(L[5][0], L[5][1], L[1][0], L[1][1], L[2][0], L[2][1], L[6][0], L[6][1], 0, 1);
			}
	}
	...
	if (mull_equ_and_observer[4] >= 0)
	{
			...
			{
				draw_figure(L[6][0], L[6][1], L[2][0], L[2][1], L[3][0], L[3][1], L[7][0], L[7][1], 1, 0);
			}
			else
			{
				draw_figure(L[6][0], L[6][1], L[2][0], L[2][1], L[3][0], L[3][1], L[7][0], L[7][1], 0, 1);
			}
	}
	...
	if (mull_equ_and_observer[5] >= 0)
	{
			...
			{
				draw_figure(L[7][0], L[7][1], L[3][0], L[3][1], L[0][0], L[0][1], L[4][0], L[4][1], 1, 0);
			}
			else
			{
				draw_figure(L[7][0], L[7][1], L[3][0], L[3][1], L[0][0], L[0][1], L[4][0], L[4][1], 0, 1);
			}
	}
}
...
int Figure::fill(int x_pixel, int y_pixel, int flag, bool **array_of_paint_pixel)
{
	...
	if (array_of_paint_pixel[y_pixel][x_pixel] != true)
	{
		...
		while (stack_obg.empty() != true)
		{
			...
			{
				putpixel(i, y_now, RGB(color1, color2, color3));
			}
...
void Figure::draw_shadow()
{
	...
	// грань из точек 0-1-2-3-0
	draw_figure(L[0][0], L[0][1], L[1][0], L[1][1], L[2][0], L[2][1], L[3][0], L[3][1], 0, 0);//0-1-2-3

	// грань из точек 4-5-6-7
	draw_figure(L[4][0], L[4][1], L[5][0], L[5][1], L[6][0], L[6][1], L[7][0], L[7][1], 0, 0);//4-5-6-7

	// грань из точек 0-1-5-4
	draw_figure(L[0][0], L[0][1], L[1][0], L[1][1], L[5][0], L[5][1], L[4][0], L[4][1], 0, 0);//0-1-5-4

	// грань из точек 5-1-2-6
	draw_figure(L[5][0], L[5][1], L[1][0], L[1][1], L[2][0], L[2][1], L[6][0], L[6][1], 0, 0);

	// грань из точек 6-2-3-7
	draw_figure(L[6][0], L[6][1], L[2][0], L[2][1], L[3][0], L[3][1], L[7][0], L[7][1], 0, 0);

	// грань из точек 7-3-0-4
	draw_figure(L[7][0], L[7][1], L[3][0], L[3][1], L[0][0], L[0][1], L[4][0], L[4][1], 0, 0);
}
...
void Figure::roat(int flag, int flag2)
{
	Figure N(0);
	N = *this;
